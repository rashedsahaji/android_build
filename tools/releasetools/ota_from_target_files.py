...
""" % bcb_dev)
  ...
  script.Print(" ")
  script.Print(" _  _   __   _  _  ____  __   ____  ")
  script.Print("/ )( \ / _\ / )( \(  __)/  \ / ___) ")
  script.Print("\ /\ //    \\ \/ / ) _)(  O )\___ \ ")
  script.Print("(_/\_)\_/\_/ \__/ (____)\__/ (____/ ")
  script.Print(" ")
  script.Print(" ")
  ...
  if target_info.GetBuildProp("ro.wave.display.version") is not None:
    buildid = target_info.GetBuildProp("ro.wave.display.version")
    ...
    device = target_info.GetBuildProp("ro.wave.device")
